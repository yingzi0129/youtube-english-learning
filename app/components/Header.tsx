            ...
            <div className="flex items-center gap-1.5 sm:gap-3 flex-shrink-0">
              ...
              {isAdmin && (
                <button
                  ...
                  className="flex items-center justify-center gap-1 px-2 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm sm:text-base rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105"
                >
              ...
              <button className="hidden sm:flex items-center px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm sm:text-base rounded-full hover:shadow-lg transition-all duration-300 hover:scale-105">
                视频库
              </button>
              <button
                onClick={() => router.push('/learning-history')}
                className="hidden md:block px-4 py-2 text-gray-700 bg-white/80 border border-purple-100 hover:border-purple-200 hover:bg-purple-50 rounded-full transition-all text-sm sm:text-base font-medium shadow-sm hover:shadow-md"
              >
                学习记录
              </button>
              <button
